...
namespace NHS_AssetTracker.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(ApplicationUser user) /* Changed IdentityUser to ApplicationUser - Athar 03.04.2020*/
        {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("NHS_AssetTracker"),
